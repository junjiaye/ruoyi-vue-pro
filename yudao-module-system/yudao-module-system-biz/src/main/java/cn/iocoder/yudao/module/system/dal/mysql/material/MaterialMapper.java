...
import cn.iocoder.yudao.module.system.controller.admin.group.vo.GroupPageReqVO;
...
public interface MaterialMapper extends BaseMapperX<MaterialDO> {
    ...
    default List<MaterialDO> selectList(GroupExportReqVO reqVO) {
        return selectList(new LambdaQueryWrapperX<MaterialDO>()
                .likeIfPresent(MaterialDO::getMaterialname, reqVO.getName())
                .eqIfPresent(MaterialDO::getMaterialstatus, reqVO.getStatus())
                .betweenIfPresent(MaterialDO::getCreateTime, reqVO.getCreateTime())
                .orderByDesc(MaterialDO::getId));
    }
